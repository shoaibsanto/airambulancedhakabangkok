...
export const NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/gallery", label: "Awards & Recognition" },
      { href: "/faq", label: "FAQ" },
    ],
  },
  { href: "/blog", label: "Guides", children: [
      { href: "/guides/air-ambulance-dhaka-bangkok", label: "Air Ambulance Dhaka to Bangkok" },
      { href: "/guides/icu-air-ambulance-dhaka", label: "ICU Air Ambulance Dhaka" },
      { href: "/blog", label: "All Resources" },
    ] },
